      ...
      <>
        ...
        <div className="flex lg:flex-row flex-col 2xl:max-w-[70%] 2xl:m-auto">
          ...
          {isInView && usplist.map((u: any) => (
                    <motion.div variants={AppearFromBelow} initial={AppearFromBelow.start} animate={AppearFromBelow.finish} transition={transition} className="h-full min-[450px]:!h-[150px] gap-[20px] flex flex-row pt-[28px] w-full justify-center items-center">
                      <div className="w-[40%] flex justify-center">
                        {u.image?.filename && (
                          <Image src={u.image.filename} priority width={100} height={100} objectFit="cover" alt={u.image.alt || 'muller technology usp icons'} className="lg:ml-[2em]" />
                        )}
