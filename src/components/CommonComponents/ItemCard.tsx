            ...
            data&&data.map((blok:any,index)=>{
              ...
              return(
                <Skeleton isLoaded={!isLoading} fitContent={true} key={blok._uid} > 
                    <div className=' flex flex-col w-full md:w-[95%] 1400px:w-[95%] lg:w-[90%] xl:w-[90%] pr-[10px] md:px-0 px-[15px] min-h-[400px] md:min-h-[600px] lg:h-[780px] xl:h-auto justify-between gap-[20px] py-[18px] xl:py-[30px]' key={blok.uuid} >
                    {
                      isInView&&
                    ...
                    }
                    {
                      isInView&&<motion.div className=' h-full flex flex-col gap-1 md:justify-strech ' variants={AppearFromBottom} initial={AppearFromBottom.start} animate={AppearFromBottom.finish} transition={transition} >
                        <h3 className='max-h-[200px] overflow-hidden min-[1400px]:text-[39px] min-[1200px]:text-[34px] min-[1010px]:w-[60%] min-[1400px]:w-[100%] '>{stop.heading}</h3>
