...
export default function contactnew({blok}:{blok:any}){
    ...
    return(
        <div ref={ref} className=" overflow-hidden min-h-screen lg:h-auto flex flex-col justify-center px-[1em] md:px-[3em] xl:px-[5em] py-[4em] md:py-[6em] lg:py-[8em] gap-[80px] " style={{backgroundColor:colors[0].background_color,color:colors[0].text_color}} id={blok.anchor_id} {...storyblokEditable(blok)}>
            ...
            <div className=" flex flex-col min-[964px]:grid min-[964px]:grid-cols-2 gap-10 md:justify-between">
                        ...
                        <div className=" flex flex-col gap-10 justify-between ">
                            ...
                            <div className=" flex flex-col gap-7">
                            {
                                l.image.map((image:any)=>(
                                    ...
                                    <AnimateXAxisComponent key={image._uid} X={400} className=" self-center h-[400px] relative w-[400px]">
                                        <Image src={image.filename} fill objectFit="cover" sizes="(min-width: 400px) 400px" alt={image.alt} />
